...
export const create = ({ name, price, image }) => {
    return new materialsModel({ name, price, image }).save();
};
...
const dataFilter = [
    ...
    },
    {
        ...
        query: { price: { $gt: 100000, $lt: 500000 } },
        sortPrice: { price: 1 },
    },
    {
        value: 4,
...
export const findMaterials = async (filterInput) => {
    ...
    return await materialsModel.aggregate([{ $match: findObjFilter.query }, { $sort: findObjFilter.sortPrice }]);
};
